      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
            ...
            These prestigious awards recognize UBBIM Resources' commitment to transforming 
            Malaysia's built environment through cutting-edge technology and responsible practices.
          </p>
        </div>
