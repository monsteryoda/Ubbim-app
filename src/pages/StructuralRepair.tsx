...
const StructuralRepair = () => {
  useEffect(() => {
    document.title = "Structural Repair and Refurbishment - UBBIM";
    return () => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                UBBIM delivers comprehensive structural repair and refurbishment solutions with a focus on safety, innovation, and client satisfaction.
              </p>
...
export default StructuralRepair;