                    ...
                    <div key={project.id} className="w-full flex-shrink-0">
                      <Card className="border-none">
                        <CardContent className="p-0">
                          <div className="relative aspect-[16/9] overflow-hidden">
                            <img
                              src={index === 0 ? "/src/assets/projects/highlights-banner.png" : index === 1 ? "/src/assets/projects/highlights-2.png" : index === 2 ? "/src/assets/projects/highlights-3.png" : project.image}
                              alt={index === 0 ? "Digital Permit to Work System" : index === 1 ? "Financial Summary Dashboard" : index === 2 ? "Lorry Movement Tracking" : project.title}
                              className="w-full h-full object-cover"
                            />
                            {index === 0 && (
                              <>
