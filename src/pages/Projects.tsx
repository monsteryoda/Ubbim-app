                      ...
                      <div key={project.id} className="w-full flex-shrink-0">
                        <Card className="border-none">
                          <CardContent className="p-0">
                            <div className="relative aspect-[16/9] overflow-hidden">
                              <img
                                src={digitalIndex === 0 ? "/src/assets/projects/highlights-banner.png" : digitalIndex === 1 ? "/src/assets/projects/highlights-2.png" : digitalIndex === 2 ? "/src/assets/projects/highlights-3.png" : digitalIndex === 3 ? "/src/assets/projects/highlights-4.png" : digitalIndex === 4 ? "/src/assets/projects/highlights-5.png" : digitalIndex === 5 ? "/src/assets/projects/highlights-6.png" : project.image}
                                alt={digitalIndex === 0 ? "Financial Summary Dashboard" : digitalIndex === 1 ? "Lorry Movement Tracking" : digitalIndex === 2 ? "Aerial Analytics Services" : digitalIndex === 3 ? "3D Scanning and Facility Management" : digitalIndex === 4 ? "3D Process Animation Video for a Waste to Energy Plant in Johor" : digitalIndex === 5 ? "Virtual Reality Remodelling of a Storage Warehouse in Melaka" : project.title}
                                className="w-full h-full object-cover"
                              />
                              {digitalIndex === 0 && (
                                <>
