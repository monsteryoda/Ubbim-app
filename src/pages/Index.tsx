        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
              Delivering excellence in design, build, and construction management services
            </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#1A4B8C] mb-4">
              Our Services
            </h2>
            ...
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link to={`/services`} className="inline-flex items-center text-[#1A4B8C] hover:text-[#4ADE80] font-medium transition-colors">
                    Learn More
