...
import { ArrowRight, Shield, Camera, Lock, Eye, Smartphone, AlertTriangle, Wrench, CheckCircle, Building2, Clock, Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin } from "lucide-react";
...
const Index = () => {
  const services = [
    {
      title: "Design & Build",
      description: "Comprehensive design and construction services that streamline your project from concept to completion.",
      image: "/src/assets/design-build.jpg"
    },
    {
      title: "Firefighting Services",
      description: "Advanced fire protection systems including sprinklers, alarms, and suppression systems for maximum safety.",
      image: "/src/assets/firefighting.jpg"
    },
    {
      title: "Security & Surveillance",
      description: "State-of-the-art security systems including CCTV, access control, and intrusion detection solutions.",
      image: "/src/assets/security-surveillance.jpg"
    },
    {
      title: "Construction Management",
      description: "Professional project management ensuring your construction projects are delivered on time and within budget.",
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-8">
              Delivering excellence in design, construction, and security solutions for over two decades.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer comprehensive construction and security solutions tailored to meet your unique needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="space-y-8 md:pr-12">
              <div className="text-right md:text-right">
                ...
                <p className="text-gray-600 leading-relaxed text-right">
                  We coordinate seamlessly between design and construction teams for optimal project outcomes.
                </p>
              </div>
              <div className="text-right md:text-right">
                <h3 className="text-2xl font-bold text-[#1A4B8C] mb-3">
                ...
                <p className="text-gray-600 leading-relaxed text-right">
                  Our streamlined processes reduce project timelines without compromising quality.
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="aspect-[16/10] overflow-hidden rounded-2xl shadow-2xl">
                <img 
                  src="/src/assets/construction-site.jpg" 
                  alt="Why Choose UBBIM" 
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
            ...
            <div className="space-y-8 md:pl-12">
              <div className="text-left md:text-left">
                ...
                <p className="text-gray-600 leading-relaxed text-left">
                  Rigorous quality control measures throughout every phase of the project lifecycle.
                </p>
              </div>
              <div className="text-left md:text-left">
                <h3 className="text-2xl font-bold text-[#1A4B8C] mb-3">
                ...
                <p className="text-gray-600 leading-relaxed text-left">
                  Regular maintenance and prompt technical support to keep your systems operational.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-6">
                UBBIM delivers comprehensive construction and security solutions with a focus on safety, innovation, and client satisfaction.
              </p>
